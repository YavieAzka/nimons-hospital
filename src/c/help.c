...
void print_helpMessage_manager(User usernow){
    ...
    printf("    4. LIHAT_USER\n");
    printf("    5. LIHAT_PASIEN\n");
    printf("    6. LIHAT_DOKTER\n");
    printf("    7. CARI_USER\n");
    printf("    8. CARI_PASIEN\n");
    printf("    9. CARI_DOKTER\n");
    printf("    10. LIHAT_DENAH\n");
    printf("    11. LIHAT_RUANGAN\n");
    printf("    12. LIHAT_SEMUA_ANTRIAN\n");
    printf("    13. UBAH_DENAH\n");
    printf("    14. PINDAH_DOKTER\n");
    printf("    15. EXIT\n");
    printf("Footnote: =====================================================================\n");
    printf("    1. Untuk menggunakan aplikasi, silahkan masukkan perintah yang terdaftar.\n");
    printf("    2. Jangan lupa untuk memasukkan input yang valid.\n");
